	...
	<div class="container">
		...
		<form action="update.bo" enctype="multipart/form-data" method="post"
			...
			<table class="table table-hover">
				...
				<tr>
					<th>제목</th>
					<td><input type="text" name="subject" value="${board.b_name}"
						required="required" autofocus="autofocus"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea rows="5" cols="30" name="content"
							required="required">${board.b_cnt }</textarea></td>
				</tr>
				<tr>
					<th scope="row">첨부파일</th>
					<td><input type="file" name="filename"><img alt=""
						src="upload/${board.f_name }" width="400"></td>
				</tr>
				<tr>
		...
		<div class="btn_right mt15">
			<input type="button" class="btn black mr5"
				onclick="location.href='list.bo'" value="목록으로">
		</div>
	</div>
</body>
</html>