	...
	<div class="bodyContainer">
		...
		<section class="posts">
			<c:forEach var="board" items="${list }">
					<div class="post" onClick="location.href='view.bo?b_num=${board.b_num }&pageNum=${currentPage}'">
					<div class="thumbnail">
						<img alt="" src="/roy/upload/${board.f_name }" width="200" height="200">
					</div>
					<div class="write"><div class="bNamedateBox">${board.b_name } </div>
						<div class="bCntBox">${board.b_cnt}</div><button class="ReadButton">Read More</button> <div class="bIdViewBox">아이디${board.m_id }&emsp;조회수${board.b_view }&emsp;작성일${board.b_date }</div></div>
				</div>
			</c:forEach>
		</section>
		<div align="center">
